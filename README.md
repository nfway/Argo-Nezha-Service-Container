...
```
curl -L https://raw.githubusercontent.com/nfway/Argo-Nezha-Service-Container/master/install.sh -o nezha.sh && chmod +x nezha.sh && sudo ./nezha.sh install_agent nezha.seales.nom.za 443 eAxO9IF519fKFODlW0 --tls
```
